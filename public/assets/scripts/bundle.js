...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\nconst getIPAddress = () => {\n  var ipaddress;\n  var http = new XMLHttpRequest();\n  var url = \"https://api.ipify.org?format=json\";\n  http.open(\"GET\", url);\n  http.send();\n\n  http.onreadystatechange = function () {\n    if (http.readyState === XMLHttpRequest.DONE) {\n      var response = JSON.parse(http.responseText);\n      setIPAddress(response);\n    }\n  };\n\n  function setIPAddress(response) {\n    ipaddress = response.ip;\n    localStorage.setItem(\"ip\", ipaddress);\n  }\n\n  return ipaddress;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getIPAddress); // function resolveAfter2Seconds() {\n//   console.log(\"starting slow promise\")\n//   return new Promise(resolve => {\n//     setTimeout(function () {\n//       resolve(\"slow\")\n//       console.log(\"slow promise is done\")\n//     }, 2000)\n//   })\n// }\n\n//# sourceURL=webpack://live-reload-vanilla-website-template/./src/scripts/components/getIPAddress.js?");

/***/ }),

/***/ "./src/scripts/components/getLocationByIp.js":
/*!***************************************************!*\
  !*** ./src/scripts/components/getLocationByIp.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _vars_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vars.js */ \"./src/scripts/vars.js\");\n/* harmony import */ var _vars_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vars_js__WEBPACK_IMPORTED_MODULE_0__);\n // need to refactor to use API route\n\nconst getLocationByIp = async () => {\n  var ipaddress = localStorage.getItem('ip');\n  ;\n  var http = new XMLHttpRequest(); // var url = `http://localhost:3030/users`\n\n  var url = `http://api.ipstack.com/${ipaddress}?access_key=${_vars_js__WEBPACK_IMPORTED_MODULE_0__.apikeys.API_KEY_IPSTACK}`;\n  http.open(\"GET\", url);\n  http.send();\n\n  http.onreadystatechange = function () {\n    if (http.readyState === XMLHttpRequest.DONE) {\n      var response = JSON.parse(http.responseText);\n      setLocation(response); // console.log(response)\n    }\n  };\n};\n\nfunction setLocation(response) {\n  let locationdata = response;\n  let city = response.city;\n  let state = response.region_name;\n  let country = response.country_code;\n  let zip = response.zip;\n  let latitude = response.latitude;\n  let longitude = response.longitude;\n  localStorage.setItem(\"city\", city);\n  localStorage.setItem(\"state\", state);\n  localStorage.setItem(\"country\", country);\n  localStorage.setItem(\"zip\", zip);\n  localStorage.setItem(\"latitude\", latitude);\n  localStorage.setItem(\"longitude\", longitude);\n  return locationdata.city;\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getLocationByIp);\n\n//# sourceURL=webpack://live-reload-vanilla-website-template/./src/scripts/components/getLocationByIp.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _vars__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vars */ \"./src/scripts/vars.js\");\n/* harmony import */ var _vars__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vars__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _attachToPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./attachToPage */ \"./src/scripts/components/attachToPage.js\");\n/* harmony import */ var _getIPAddress__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getIPAddress */ \"./src/scripts/components/getIPAddress.js\");\n/* harmony import */ var _getLocationByIp__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getLocationByIp */ \"./src/scripts/components/getLocationByIp.js\");\n\n\n\n\n(0,_getIPAddress__WEBPACK_IMPORTED_MODULE_2__.default)();\n(0,_getLocationByIp__WEBPACK_IMPORTED_MODULE_3__.default)();\n\nfunction requestEventsByIP(locations) {\n  var theFeed = document.getElementById('evenfeed');\n  var eventData = [];\n  var liveStreamData = [];\n  var latitude = localStorage.getItem('latitude');\n  var longitude = localStorage.getItem('longitude');\n  var state = localStorage.getItem('state');\n  var city = localStorage.getItem('city');\n  theFeed.innerHTML = '';\n  var http = new XMLHttpRequest();\n  var url = 'https://edmtrain.com/api/events?latitude=' + latitude + '&longitude=' + longitude + '&state=' + state + '&client=' + _vars__WEBPACK_IMPORTED_MODULE_0__.apikeys.API_KEY_EDMTRAIN;\n  http.open('GET', url);\n  http.send();\n\n  http.onreadystatechange = function () {\n    if (http.readyState === XMLHttpRequest.DONE && http.status === 200) {\n      var response = JSON.parse(http.responseText);\n      /*Puts the Data into our array*/\n\n      parseData(response);\n      console.log(response);\n      /*Attaches the data to the page*/\n\n      (0,_attachToPage__WEBPACK_IMPORTED_MODULE_1__.default)(eventData, locations, theFeed, city);\n    }\n  };\n\n  function parseData(result) {\n    for (var g = 0; g < result.data.length; g++) {\n      /*get date converted to numerical value*/\n      //   console.log(result.data[g].startTime);\n\n      /*convert date to ISO for Schema and Readble Formats*/\n      //   var eventDateParsed = Date.parse(result.data[g].date);\n      var eventDateISO = new Date(result.data[g].date);\n      var readableDate = new Date(result.data[g].date).toDateString(); // Create Event Object\n\n      var singleEventListing = {\n        id: result.data[g].id,\n        name: result.data[g].name,\n        date: readableDate,\n        link: result.data[g].link,\n        venuename: result.data[g].venue.name,\n        venueaddress: result.data[g].venue.address,\n        venuecity: result.data[g].venue.location,\n        venuestate: result.data[g].venue.state,\n        artist: [result.data[g].artistList],\n        image: '',\n        schemadate: eventDateISO,\n        starttime: result.data[g].startTime // image: data[g].eventImage,\n        // age: data[g].ageLabel,\n\n      };\n      /*Push To Event DAta Array if not Live Stream*/\n\n      if (singleEventListing.venuename != 'Live Stream') {\n        eventData.push(singleEventListing);\n      } else {\n        liveStreamData.push(singleEventListing);\n      }\n    }\n  }\n\n  return eventData;\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (requestEventsByIP);\n\n//# sourceURL=webpack://live-reload-vanilla-website-template/./src/scripts/components/requestEventsByIP.js?");
