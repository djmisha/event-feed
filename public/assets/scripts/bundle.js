...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _attachToPage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./attachToPage */ \"./src/scripts/components/attachToPage.js\");\n/* harmony import */ var _getIPAddress__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getIPAddress */ \"./src/scripts/components/getIPAddress.js\");\n/* harmony import */ var _getLocationByIp__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getLocationByIp */ \"./src/scripts/components/getLocationByIp.js\");\n\n\n\n(0,_getIPAddress__WEBPACK_IMPORTED_MODULE_1__.default)();\n(0,_getLocationByIp__WEBPACK_IMPORTED_MODULE_2__.default)();\n\nfunction requestEventsByIP(locations) {\n  var theFeed = document.getElementById('evenfeed');\n  var eventData = [];\n  var liveStreamData = [];\n  var latitude = localStorage.getItem('latitude');\n  var longitude = localStorage.getItem('longitude');\n  var state = localStorage.getItem('state');\n  var city = localStorage.getItem('city');\n  theFeed.innerHTML = '';\n  var http = new XMLHttpRequest(); // events?latitude=33.962&longitude=-118.358&state=California&client=...\n\n  var url = 'https://edmtrain.com/api/events?latitude=' + latitude + '&longitude=' + longitude + '&state=' + state + '&client=47211b0d-26f7-424c-b81c-45613a70f865';\n  http.open('GET', url);\n  http.send();\n\n  http.onreadystatechange = function () {\n    if (http.readyState === XMLHttpRequest.DONE && http.status === 200) {\n      var response = JSON.parse(http.responseText);\n      /*Puts the Data into our array*/\n\n      parseData(response);\n      console.log(response);\n      /*Attaches the data to the page*/\n\n      (0,_attachToPage__WEBPACK_IMPORTED_MODULE_0__.default)(eventData, locations, theFeed, city);\n    }\n  };\n\n  function parseData(result) {\n    for (var g = 0; g < result.data.length; g++) {\n      /*get date converted to numerical value*/\n      //   console.log(result.data[g].startTime);\n\n      /*convert date to ISO for Schema and Readble Formats*/\n      //   var eventDateParsed = Date.parse(result.data[g].date);\n      var eventDateISO = new Date(result.data[g].date);\n      var readableDate = new Date(result.data[g].date).toDateString(); // Create Event Object\n\n      var singleEventListing = {\n        id: result.data[g].id,\n        name: result.data[g].name,\n        date: readableDate,\n        link: result.data[g].link,\n        venuename: result.data[g].venue.name,\n        venueaddress: result.data[g].venue.address,\n        venuecity: result.data[g].venue.location,\n        venuestate: result.data[g].venue.state,\n        artist: [result.data[g].artistList],\n        image: '',\n        schemadate: eventDateISO,\n        starttime: result.data[g].startTime // image: data[g].eventImage,\n        // age: data[g].ageLabel,\n\n      };\n      /*Push To Event DAta Array if not Live Stream*/\n\n      if (singleEventListing.venuename != 'Live Stream') {\n        eventData.push(singleEventListing);\n      } else {\n        liveStreamData.push(singleEventListing);\n      }\n    }\n  }\n\n  return eventData;\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (requestEventsByIP);\n\n//# sourceURL=webpack://live-reload-vanilla-website-template/./src/scripts/components/requestEventsByIP.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_requestEventsByIP__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/requestEventsByIP */ \"./src/scripts/components/requestEventsByIP.js\");\n/* harmony import */ var _components_requestLocations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/requestLocations */ \"./src/scripts/components/requestLocations.js\");\n/* harmony import */ var _components_navigationDropdowns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/navigationDropdowns */ \"./src/scripts/components/navigationDropdowns.js\");\n/* harmony import */ var _components_navigationMobile__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/navigationMobile */ \"./src/scripts/components/navigationMobile.js\");\n\n\n\n // import requestPostsAndAttachtoPage from './components/requestsPosts';\n// Initialize Application\n\nlet locations = (0,_components_requestLocations__WEBPACK_IMPORTED_MODULE_1__.default)();\n(0,_components_requestEventsByIP__WEBPACK_IMPORTED_MODULE_0__.default)(locations);\n(0,_components_navigationDropdowns__WEBPACK_IMPORTED_MODULE_2__.default)();\n(0,_components_navigationMobile__WEBPACK_IMPORTED_MODULE_3__.default)(); // requestPostsAndAttachtoPage('music', 8);\n\n//# sourceURL=webpack://live-reload-vanilla-website-template/./src/scripts/main.js?");
